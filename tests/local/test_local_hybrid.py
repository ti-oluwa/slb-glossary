...
class TestGetResultKey:
    def test_returns_url_topic_tuple(self):
    ...
    def test_falls_back_to_empty_string_topic(self):
    ...
    def test_returns_none_for_result_with_no_url(self):
...
class TestComputeRrfScores:
    def test_single_ranker_scores_by_reciprocal_rank(self):
    ...
    def test_key_missing_from_a_ranking_gets_no_penalty_term(self):
    ...
    def test_zero_weight_ranker_is_skipped_entirely(self):
    ...
    def test_lower_k_weighs_top_ranks_more_heavily(self):
...
class TestHybridSearch:
    async def test_exact_name_match_is_always_ranked_first(self, db, mock_embeddings):
    ...
    async def test_name_tier_result_is_not_duplicated_in_the_fused_tier(self, db, mock_embeddings):
    ...
    async def test_semantic_only_match_still_surfaces_via_fusion(self, db, mock_embeddings):
    ...
    async def test_fused_scores_are_normalized_into_zero_one_range(self, db, mock_embeddings):
    ...
    async def test_semantic_weight_zero_ignores_semantic_ranking(self, db, mock_embeddings):
    ...
    async def test_no_match_returns_empty_list(self, db, mock_embeddings):
