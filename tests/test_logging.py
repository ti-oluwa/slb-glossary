...
class TestConsoleSink:
    def test_write_appends_newline_to_stream(self) -> None:
    ...
    def test_close_does_not_close_the_underlying_stream(self) -> None:
...
class TestStderrStdoutSink:
    def test_stderr_sink_targets_sys_stderr(self) -> None:
        """`StderrSink()` writes to `sys.stderr`."""
        assert StderrSink()._stream is sys.stderr

    def test_stdout_sink_targets_sys_stdout(self) -> None:
        """`StdoutSink()` writes to `sys.stdout`."""
        assert StdoutSink()._stream is sys.stdout


class TestFileSink:
    def test_write_creates_parent_directory_and_appends_newline(
    ...
    def test_mode_a_appends_across_instances(self, tmp_path: pathlib.Path) -> None:
    ...
    def test_mode_w_truncates(self, tmp_path: pathlib.Path) -> None:
...
class TestCheckFilterMatches:
    def test_string_filter_uses_fnmatch_against_logger_name(self) -> None:
    ...
    def test_callable_filter_receives_the_record(self) -> None:
...
class TestSinkHandler:
    def test_single_sink_receives_every_record(self) -> None:
    ...
    def test_iterable_of_sinks_all_receive_every_record(self) -> None:
    ...
    def test_mapping_routes_records_by_filter(self) -> None:
    ...
    def test_mapping_value_can_be_an_iterable_of_sinks(self) -> None:
    ...
    def test_sinks_property_deduplicates_across_routes(self) -> None:
    ...
    def test_flush_flushes_every_sink(self) -> None:
    ...
    def test_close_closes_every_sink(self) -> None:
...
class TestImportSink:
    ...
    def test_raises_import_error_for_missing_attribute(self) -> None:
...
class TestResolveSink:
    def test_none_returns_default_or_stderr_sink(self) -> None:
    ...
    def test_instance_is_returned_as_is(self) -> None:
        """An already-constructed `LogSink` instance passes through unchanged."""
        sink = RecordingSink()
        assert resolve_sink(sink) is sink

    def test_class_is_returned_unchanged_not_instantiated(self) -> None:
    ...
    def test_stderr_console_strings_resolve_to_stderr_sink(self, spec: str) -> None:
        """`"stderr"`/`"console"` (case-insensitive) resolve to `StderrSink`."""
        assert isinstance(resolve_sink(spec), StderrSink)

    def test_stdout_string_resolves_to_stdout_sink(self) -> None:
        """`"stdout"` resolves to `StdoutSink`."""
        assert isinstance(resolve_sink("stdout"), StdoutSink)

    def test_import_path_string_resolves_via_import_sink(self) -> None:
    ...
    def test_plain_path_object_is_wrapped_in_file_sink(self, tmp_path: pathlib.Path) -> None:
...
class TestResolveSinks:
    def test_single_spec_returns_a_single_sink(self) -> None:
        """A single spec (not a collection) resolves to one `LogSink`, not a list."""
        result = resolve_sinks("stderr")
        assert isinstance(result, StderrSink)

    def test_iterable_spec_returns_a_list_of_sinks(self) -> None:
    ...
    def test_mapping_spec_returns_a_mapping_of_lists(self) -> None:
...
class TestSetLogLevel:
    def test_sets_level_by_name(self) -> None:
    ...
    def test_sets_level_by_numeric_value(self) -> None:
...
class TestConfigureLogging:
    def test_attaches_a_sinkhandler_to_the_named_logger(self) -> None:
    ...
    def test_repeat_calls_remove_previous_sinkhandler(self) -> None:
    ...
    def test_propagate_defaults_to_false(self) -> None:
    ...
    def test_returned_handler_writes_through_to_the_sink(self) -> None:
