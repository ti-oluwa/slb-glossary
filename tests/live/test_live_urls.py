...
class TestGetGlossaryBaseUrl:
    ...
    def test_builds_url_for_given_language(self):
...
class TestBuildPagerQuery:
    def test_tab_one_returns_empty_string(self):
...
class TestBuildSearchUrl:
    def test_no_filters_returns_base_url_unchanged(self):
    ...
    def test_start_letter_only(self):
    ...
    def test_start_letter_uses_only_the_first_character_uppercased(self):
    ...
    def test_query_topic_and_start_letter_combine(self):
    ...
    def test_pager_query_is_inserted_before_sort(self):
