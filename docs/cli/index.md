...
Audience: anyone using the `slb` command from a terminal. No programming knowledge assumed anywhere in this section. If you haven't installed the tool yet, see [Installation](../getting-started/installation.md).
